...
export const SkeletonCard: React.FC = () => {
  return (
    <div className="bg-white/40 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm dark:shadow-lg animate-pulse flex flex-col justify-between h-48">
      <div>
        <div className="flex items-center justify-between mb-3">
          <div className="w-20 h-5 bg-slate-200 dark:bg-slate-800 rounded-full"></div>
          <div className="w-14 h-5 bg-slate-200 dark:bg-slate-800 rounded-full"></div>
        </div>
        <div className="w-3/4 h-5 bg-slate-200 dark:bg-slate-800 rounded mb-2"></div>
        <div className="w-full h-4 bg-slate-200/80 dark:bg-slate-800/60 rounded mb-1"></div>
        <div className="w-2/3 h-4 bg-slate-200/80 dark:bg-slate-800/60 rounded"></div>
      </div>
